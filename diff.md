% Diff between report from "January 24, 2022" and reference report from "January 24, 2022"
% Strudy
% January 24, 2022
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* AbortSignal, Event, EventHandler, EventInit, EventTarget, Window
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* HTMLAnchorElement, Window
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* HTMLMediaElement, Navigator
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* EventHandler, EventTarget
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* EventHandler, EventTarget, Navigator
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* DataTransfer, Event, EventInit, EventTarget, Navigator
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventHandler, EventInit, EventTarget, Window
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* AbortSignal, HTMLFormElement, Navigator
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Worklet, WorkletGlobalScope
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* CSSOMString, Event, EventHandler, EventInit, GlobalEventHandlers
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* AbstractRange
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventHandler, EventInit, EventTarget
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* DocumentOrShadowRoot, Element, ProcessingInstruction, Window
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Element, EventTarget
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Document, Element, EventTarget, Node, Range
...
- Unknown WebIDL names used: *INS* DOMTokenList, Element
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Element, EventTarget, Node, Window
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventHandler, EventInit, GlobalEventHandlers
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Element
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Document, Element, Event, EventHandler, EventInit, EventListener, EventTarget, HTMLElement, HTMLImageElement, Node, Range, Text, Window
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* ElementInternals
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventHandler, EventInit, Window
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* DocumentFragment, Element, Node, Range
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Element, Event, EventHandler, EventTarget
...
- Obsolete WebIDL constructs found: *DEL* false
- Unknown WebIDL names used: *DEL* Uint8Array
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventHandler, EventInit, EventTarget, HTMLMediaElement, Navigator
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Node
...
- Unknown WebIDL names used: *INS* Document
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* AbortSignal, ReadableStream, URLSearchParams, WindowOrWorkerGlobalScope
...
- Unknown WebIDL names used: *INS* EventHandler, EventTarget, ReadableStream, URL
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* DataTransferItem, Window, WritableStream
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Document, Element
...
- Unknown WebIDL names used: *INS* Document, DocumentOrShadowRoot, Element, EventHandler
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventHandler, EventInit, Navigator, WindowEventHandlers
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* EventTarget, WindowOrWorkerGlobalScope
...
- Spec could not be rendered: *DEL* Error: Evaluation failed: Error: Respec generation took too long
    ...
    at async processSpecification (/home/runner/work/webref/webref/node_modules/reffy/src/lib/util.js:544:9)
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Document, DocumentFragment, Element
...
- Obsolete WebIDL constructs found: *DEL* false
- Unknown WebIDL names used: *DEL* ArrayBuffer, Uint8ClampedArray, WindowProxy
- WebIDL names also defined elsewhere: *DEL* MessageEventSource
...
- Unknown [Exposed] names used: *INS* DedicatedWorker, Window
- Unknown WebIDL names used: *INS* AbortSignal, EventHandler, EventTarget
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* DOMStringList, Event, EventHandler, EventInit, EventTarget, WindowOrWorkerGlobalScope
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Element, Navigator
...
- Unknown WebIDL names used: *INS* DataTransfer, StaticRange
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* EventTarget
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* EventTarget, Navigator
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventHandler, EventInit, EventTarget, Navigator
...
- Unknown [Exposed] names used: *INS* DedicatedWorker, Window
- Unknown WebIDL names used: *INS* AudioTrack, AudioTrackList, EventHandler, EventTarget, TextTrack, TextTrackList, TimeRanges, VideoTrack, VideoTrackList
...
- Unknown [Exposed] names used: *INS* DedicatedWorker
...
- Unknown WebIDL names used: *INS* Document, EventHandler
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* EventHandler, EventTarget, Navigator, WorkerNavigator
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Document, HTMLIFrameElement
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Document, DocumentOrShadowRoot, Element, Event, EventHandler, EventInit, EventTarget, HTMLVideoElement
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Element, EventHandler, GlobalEventHandlers, Navigator
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventHandler, EventInit, EventTarget, HTMLElement, MessagePort, Window, WindowEventHandlers
- WebIDL names also defined elsewhere: *DEL* MessageEventSource
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* BinaryType, Event, EventHandler, EventInit, EventTarget, Navigator
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* AbortController, AbortSignal, Event, EventHandler, EventInit, WindowOrWorkerGlobalScope
...
- Unknown WebIDL names used: *INS* HTMLIFrameElement, HTMLImageElement, HTMLLinkElement, HTMLScriptElement
...
- Unknown WebIDL names used: *INS* HTMLAnchorElement
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* EventHandler, EventTarget, HTMLMediaElement
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* DOMTokenList, Document, Element, NodeList, ShadowRoot
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Document, EventHandler, GlobalEventHandlers, Node, Range, Window
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventHandler, EventInit, EventTarget, MessagePort, Navigator, StructuredSerializeOptions, WindowOrWorkerGlobalScope, WorkerGlobalScope, WorkerNavigator, WorkerType
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventHandler, Window
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* EventHandler, EventTarget, GlobalEventHandlers
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventInit, EventTarget, Node, Window
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* ElementContentEditable, EventHandler, EventTarget, Navigator
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* EventHandler, EventTarget, Window
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Document, DocumentOrShadowRoot, Element, Event, EventHandler, EventInit, EventTarget
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Element, Event, EventInit
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventHandler, EventInit, EventTarget, HTMLMediaElement, MessagePort, Worklet, WorkletGlobalScope
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* AbortSignal, Event, EventHandler, EventInit, EventTarget, Navigator
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* AbortSignal, Event, EventHandler, EventInit, EventTarget
...
- Unknown [Exposed] names used: *INS* DedicatedWorker, Window
- Unknown WebIDL names used: *INS* EventHandler, EventTarget, Navigator, ReadableStream, WorkerNavigator, WritableStream
...
- Unknown [Exposed] names used: *INS* DedicatedWorker, Window
- Unknown WebIDL names used: *INS* CanvasImageSource, ColorSpaceConversion, EventHandler, EventTarget, PremultiplyAlpha, ReadableStream
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventInit, HTMLCanvasElement, HTMLImageElement, HTMLVideoElement, ImageBitmap, ImageData, OffscreenCanvas
...
- Unknown [Exposed] names used: *INS* DedicatedWorker, Window
- Unknown WebIDL names used: *INS* Event, EventHandler, EventInit, EventTarget, HTMLCanvasElement, HTMLVideoElement, ImageBitmap, OffscreenCanvas
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* BinaryType, Event, EventHandler, EventInit, EventTarget
...
- Unknown [Exposed] names used: *INS* DedicatedWorker, Window
- Unknown WebIDL names used: *INS* DedicatedWorkerGlobalScope, Event, EventHandler, EventInit, ReadableStream, Worker, WritableStream
...
- Unknown [Exposed] names used: *INS* DedicatedWorker, SharedWorker, Window
- Unknown WebIDL names used: *INS* Event, EventHandler, EventInit, EventTarget, Navigator, WorkerNavigator
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* DocumentFragment, TextTrackCue
...
- Unknown WebIDL names used: *INS* Element, EventHandler, GlobalEventHandlers
...
- Unknown [Exposed] names used: *INS* Window
- Unknown WebIDL names used: *INS* Event, EventHandler, EventInit, HTMLVideoElement
...
- Unknown [Exposed] names used: *INS* DedicatedWorker, SharedWorker, Window
- Unknown WebIDL names used: *INS* Document, Event, EventHandler, EventInit, EventTarget, HTMLFormElement
